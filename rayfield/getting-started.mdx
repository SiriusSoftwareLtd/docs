...
<Note>
  **Share your script with the community.**
  ...
  Publish your script on [RoScripts] or [scriptblox] (scriptblox.com] scriptblox will make executors show that script in game,(https://roscripts.io) so players can find your script.
</Note>
