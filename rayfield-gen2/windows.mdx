...
<ResponseField name="sidebarLayout" type="boolean" default="false">
  Put the tabs in a rail down the left instead of a strip across the top, and give the content its own card. The window is wider and shorter to suit it. On a narrow screen the rail keeps its icons and drops the labels. See [Tabs](/rayfield-gen2/tabs).
</ResponseField>
...
<ResponseField name="showName" type="string" default='"Rayfield"'>
  Label on the collapsed pill while the window is hidden.
</ResponseField>

<ResponseField name="showIcon" type="string | number" default="Rayfield icon">
  Icon on the collapsed pill while the window is hidden.
</ResponseField>

<ResponseField name="showIconOnly" type="boolean" default="false">
...
<ResponseField name="SetProfile(text?)">
...
<ResponseField name=".unloaded" type="boolean">
...
<ResponseField name="GetPath()" type="string, string">
