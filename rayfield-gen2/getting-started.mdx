...
<Note>
  Gen2 is in preview and the loader URL above is a placeholder until launch. The stable [Rayfield (2022)](/rayfield/getting-started) release loads from `https://sirius.menu/rayfield`.
</Note>
