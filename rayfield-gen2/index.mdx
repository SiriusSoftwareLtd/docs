...
Stable is the release. [Preview](/rayfield-gen2/preview) is a rolling build from `dev`, for trying what is coming next.
...
<CardGroup cols={2}>
  ...
  <Card title="Saves itself" icon="save">
    Pass a `configuration` table and every value persists and restores as its original type. No boilerplate. See [Saving](/rayfield-gen2/saving).
  </Card>
